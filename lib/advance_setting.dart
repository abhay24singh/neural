      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Dictionary 1 (Authorized Keys)", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.green)),
            Card(
            ...
            const Text("Dictionary 2 (Leak Tracking / x)", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.red)),
            Card(
              child: controller.getDic2.isEmpty 
                ? const Padding(padding: EdgeInsets.all(16), child: Text("No leaks detected yet."))
                : ListView.builder(
                    shrinkWrap: true,
                    physics: const NeverScrollableScrollPhysics(),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        leading: CircleAvatar(backgroundColor: Colors.red.shade100, child: Text("x")),
            ...
            ElevatedButton.icon(
              ...
              label: const Text("Clear Leak Database"),
